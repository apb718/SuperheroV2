...
public class ModEntities {
    public static DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, SuperheroMod.MOD_ID); // Tutorials say ENTITIES, not ENTITY_TYPES
